                ...
                if (/MicroMessenger/i.test(navigator.userAgent)) {
                    if (typeof WeixinJSBridge == "undefined") {
                        if (document.addEventListener) {
                            document.addEventListener('WeixinJSBridgeReady', selfPlay, false);
                        } else if (document.attachEvent) {
                            document.attachEvent('WeixinJSBridgeReady', selfPlay);
                            document.attachEvent('onWeixinJSBridgeReady', selfPlay);
                        }
                    } else {
                        selfPlay();
                    }
