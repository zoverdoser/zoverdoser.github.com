...
/******/ 			script.async = true;
/******/
/******/ 			script.src = __webpack_require__.p + "" + chunkId + ".build.js?" + {"0":"abc9325eb413f6ec8485","1":"7e5846686d534a77fd58","2":"967e921d8a33ff6f2192"}[chunkId] + "";
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function($) {var hex_sha1=__webpack_require__(15);
	var dtd = $.Deferred();
	var Weixin = {};
	var ticket;
	...
	Weixin.share = function (shareFriend, shareTimeline,cb) {
	    ...
	    wx.ready(function () {
	        wx.onMenuShareTimeline({
	            ...
	            success: function(){
	                if(typeof _hmt!="undefined"){
	                    _hmt.push(['_trackEvent', '乐高翻转-分享朋友圈', 'share']);
	                }
	        ...
	        wx.onMenuShareAppMessage({
	            ...
	            success: function(){
	                if(typeof _hmt!="undefined"){
	                    _hmt.push(['_trackEvent', '乐高翻转-分享给好友', 'share']);
	                }
	                if(typeof cb=="function"){
	                    cb.call();
	                }
	...
	//监听查找ibeacon
	Weixin.onSearchBeacons = function(callback) {
	    wx.onSearchBeacons({
	        complete: function(argv) {
	            if(typeof callback == 'function') {
	                callback(argv);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Weixin = __webpack_require__(14);
